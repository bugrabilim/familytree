    ...
    <div className="min-h-screen bg-bg text-text">
      <header className="sticky top-0 z-40 border-b border-border bg-bg/80 backdrop-blur-xl">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-3">
          {/* 131x36'ydı — dokunmada 44 (yükseklik satırı 64px başlıkta
              taşmıyor), farede (lg) eskisi gibi. */}
          <Link href="/" className="flex items-center gap-2.5 min-h-11 lg:min-h-0">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <p className="text-xs text-text-muted mt-2">{t("legal.updated")}</p>
        ...
        <div className="mt-8">
          {/* 169x40'tı: dört piksel eksikti ve sayfadaki TEK çıkış yolu. */}
          <Link href="/" className="inline-flex items-center gap-2 h-11 lg:h-10 px-4 rounded-xl border border-border bg-surface hover:bg-surface-2 text-sm font-medium transition-colors">
