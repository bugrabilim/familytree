import { parseExtractedJson, buildExtractPrompt, buildExtractSystem } from "../lib/ai-extract.ts";
...
const modelOut = "İşte ağaç:\n```json\n" + JSON.stringify({
  people: [
    { id: "p1", firstName: "Ahmet", lastName: "Yıldız", gender: "male", birthDate: "1950", deathDate: "2010", birthPlace: "Ankara", fatherId: null, motherId: null, spouseIds: ["p2"] },
...
check("istem EN", buildExtractSystem("en").toLowerCase().includes("family tree") && buildExtractPrompt("en").includes("spouseIds"));
